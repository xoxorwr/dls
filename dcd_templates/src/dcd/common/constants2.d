...
immutable ConstantCompletion[] pragmas = [
	...
	ConstantCompletion("crt_constructor", `
...
`),
	ConstantCompletion("crt_destructor", `
...
`),
	ConstantCompletion("linkerDirective", `
    $(P There must be one $(ASSIGNEXPRESSION) and it must evaluate at compile time to a string literal.
    )
-----------------
...
`),
	ConstantCompletion("startaddress", `
